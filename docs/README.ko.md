...
```
web:
image: protopie/enterprise-onpremises:web-9.20.0 => image: protopie/enterprise-onpremises:web-16.3.1

api:
image: protopie/enterprise-onpremises:api-9.20.0 => image: protopie/enterprise-onpremises:api-16.3.1
```
...
docker pull protopie/enterprise-onpremises:web-16.3.1
docker pull protopie/enterprise-onpremises:api-16.3.1
docker pull postgres:10.5-alpine

docker save -o nginx_1.26.3-alpine.tar nginx:1.26.3-alpine
docker save -o web_latest.tar protopie/enterprise-onpremises:web-16.3.1
docker save -o api_latest.tar protopie/enterprise-onpremises:api-16.3.1
