...
api:
image: protopie/enterprise-onpremises:api-9.20.0 => image: protopie/enterprise-onpremises:api-16.4.0
```
...
docker pull protopie/enterprise-onpremises:api-16.4.0
...
docker save -o api_latest.tar protopie/enterprise-onpremises:api-16.4.0
