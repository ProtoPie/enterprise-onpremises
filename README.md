...
```
web:
image: protopie/enterprise-onpremises:web-9.20.0 => image: protopie/enterprise-onpremises:web-14.3.01

api:
image: protopie/enterprise-onpremises:api-9.20.0 => image: protopie/enterprise-onpremises:api-14.3.01
...
docker pull protopie/enterprise-onpremises:web-14.3.01
docker pull protopie/enterprise-onpremises:api-14.3.01
docker pull postgres:10.5-alpine

docker save -o nginx_1.21.1-alpine.tar nginx:1.21.1-alpine
docker save -o web_latest.tar protopie/enterprise-onpremises:web-14.3.01
docker save -o api_latest.tar protopie/enterprise-onpremises:api-14.3.01
docker save -o postgres_10.5-alpine.tar postgres:10.5-alpine
```

**Note:** Please replace `14.3.01` with the latest version you need.
